...
# TODO: improve the spark submit command by setting the parameters dynamically depending on which user is submitting -- to be made with OpenLAVA/LSF implementation
